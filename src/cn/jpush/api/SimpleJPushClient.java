...
public class SimpleJPushClient extends BaseClient{
	 ...
	 */
	public MessageResult sendNotificationWithImei(String sendNo, String imei,  String txt) {
	 ...
	 * @return MessageResult
	 */
	public MessageResult sendCustomMessageWithImei(String sendNo, String imei, String txt) {
	 ...
	 * @return MessageResult
	 */
	public MessageResult sendNotificationWithTag(String sendNo, String tag, String txt) {
		NotifyMessageParams p = new NotifyMessageParams();
	 ...
	 * @return MessageResult
	 */
	public MessageResult sendCustomMessageWithTag(String sendNo, String tag, String txt) {
		CustomMessageParams p = new CustomMessageParams();
		p.setReceiverType(ReceiverTypeEnum.TAG);
		p.setReceiverValue(tag);
		return sendCustomMessage(p, sendNo, txt);
	 ...
	 * @return MessageResult
	 */
	public MessageResult sendNotificationWithAlias(String sendNo, String alias, String txt) {
		NotifyMessageParams p = new NotifyMessageParams();
	 ...
	 * @return MessageResult
	 */
	public MessageResult sendCustomMessageWithAlias(String sendNo, String alias, String txt) {
		CustomMessageParams p = new CustomMessageParams();
		p.setReceiverType(ReceiverTypeEnum.ALIAS);
		p.setReceiverValue(alias);
		return sendCustomMessage(p, sendNo, txt);
	 ...
	 * @return MessageResult
	 */
	public MessageResult sendNotificationWithAppKey(String sendNo, String txt) {
		NotifyMessageParams p = new NotifyMessageParams();
	 ...
	 * @return MessageResult
	 */
	public MessageResult sendCustomMessageWithAppKey(String sendNo, String txt) {
		CustomMessageParams p = new CustomMessageParams();
		p.setReceiverType(ReceiverTypeEnum.APPKEYS);
		return sendCustomMessage(p, sendNo, txt);
	}
	...
	protected MessageResult sendCustomMessage(CustomMessageParams p, String sendNo, String txt) {
		return sendMessage(p, sendNo,txt);
	}
	
	protected MessageResult sendNotification(NotifyMessageParams p, String sendNo, String txt) {

		return sendMessage(p, sendNo, txt);
	}
	
	protected MessageResult sendMessage(MessageParams p, String sendNo, String txt) {
		p.setSendNo(sendNo);
